...
class CampsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create camp" do
    assert_difference('Camp.count') do
      post camps_url, params: { camp: { name: @camp.name, phone_number: @camp.phone_number, website: @camp.website } }
    end
  ...
  test "should update camp" do
    patch camp_url(@camp), params: { camp: { name: @camp.name, phone_number: @camp.phone_number, website: @camp.website } }
